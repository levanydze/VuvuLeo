  ...
  connectedCallback() {
    ...
    <div class="top-nav">
      ...
      <ul class="menu">
        ...
        <li class="menuLi"><a href="menu.html">PHOTOGRAPHY</a></li>
        <li class="menuLi"><a href="history.html">WEB SITES</a>          </li>
        ...
        <div class="wrapper"> 
            <div class="left">
                <li class="menuLi">
                    ...
                    <ul><a class="menuBtn" href="menu.html">PHOTOGRAPHY</a></ul>
                    <ul><a class="menuBtn" href="history.html">WEB SITES</a></ul>
                    <ul><a class="menuBtn" href="contact.html">CONTACT</a></ul>
                </li>
            </div>
            <div class="right">
                <a href="index.html" class="Logo" >VuvuLeo</a>
